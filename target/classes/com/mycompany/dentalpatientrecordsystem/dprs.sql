...
INSERT INTO `patientrecords` (`id`, `given_name`, `last_name`, `middle_name`, `age`, `civil_status`, `occupation`, `contact_no`, `address`) VALUES
(1, 'Dan', 'Luayon', 'Arnaiz', 21, 'Single', 'Student', '09513872624', 'Mapua Malayan Colleges Mindanao'),
...
INSERT INTO `patientvisit` (`visit_id`, `patient_id`, `reason`, `price`, `date`) VALUES
(2, 41, 'Sakit ngipon kaayo', '600', '2024-06-09'),
...
INSERT INTO `usersdata` (`usersID`, `accessLevel`, `username`, `password`) VALUES
(1, 'Admin', 'MarkII', 'password'),
...
--
ALTER TABLE `patientvisit`
  MODIFY `visit_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `usersdata`
--
ALTER TABLE `usersdata`
  MODIFY `usersID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
