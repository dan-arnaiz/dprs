...
public class DashBoard extends javax.swing.JFrame {
  ...
  public void updatePatientRecordTable() {
    try {
      ...
      DefaultTableModel model =
          (DefaultTableModel)patientRecordTable.getModel();
      ...
      if (model.getRowCount() > 0) {
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
          ...
          String query =
              "UPDATE patientrecords SET given_name = ?, last_name = ?, middle_name = ?, age = ?, civil_status = ?, occupation = ?, contact_no = ?, address = ? WHERE id = ?";
    ...
    String totalPatientCount =
        "Total Visits: " + patientRecordTable.getModel().getRowCount();
    ...
    try {
      ...
      if (model2.getRowCount() > 0) {
        ...
        for (int i = 0; i < model2.getRowCount(); i++) {
          ...
          String query =
              "UPDATE usersdata SET accessLevel = ?, username = ?, password = ? WHERE usersID = ?";
          try (Connection conn = db.connect();
               PreparedStatement pstmt = conn.prepareStatement(query)) {
  ...
  public void refreshVisitHistory() {
    ...
    int currentId = Integer.parseInt(
        patientIDDetailsText.getText()); // Assuming patientIDUpdateText is the
                                         // JTextField for the current ID
    ...
    try {
      ...
      try (Connection conn = db.connect();
        ...
        DefaultTableModel model =
            (DefaultTableModel)patientHistoryTable.getModel();
        model.setRowCount(0);

        // Add the visit history to the patientHistoryTable
        while (rs.next()) {
          String dataVisit[] = {rs.getString("visit_id"),
                                rs.getString("reason"), rs.getString("price"),
                                rs.getString("date")};
  ...
  private void initComponents() {
    ...
    mainHeader.setFont(
        new java.awt.Font("Montserrat ExtraBold", 1, 48)); // NOI18N
    ...
    displayDashBoardButton.setFont(
        new java.awt.Font("Montserrat ExtraBold", 1, 18)); // NOI18N
    ...
    displayDashBoardButton.setBorder(
    ...
    displayDashBoardButton.addActionListener(
    ...
    logOutButton.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    javax.swing.GroupLayout mainMenuPanelLayout =
        new javax.swing.GroupLayout(mainMenuPanel);
    mainMenuPanel.setLayout(mainMenuPanelLayout);
    mainMenuPanelLayout.setHorizontalGroup(
        mainMenuPanelLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(mainHeader, javax.swing.GroupLayout.DEFAULT_SIZE,
                          1920, Short.MAX_VALUE)
            .addGroup(
                mainMenuPanelLayout.createSequentialGroup()
                    .addGap(783, 783, 783)
                    .addGroup(
                        mainMenuPanelLayout
                            .createParallelGroup(
            ...
            .addGroup(
                mainMenuPanelLayout.createSequentialGroup()
                    ...
                    .addComponent(displayDashBoardButton,
                                  ...
                                  javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(34, 34, 34)
                    .addComponent(usersDashBoardButton,
                                  javax.swing.GroupLayout.PREFERRED_SIZE, 80,
                                  javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(31, 31, 31)
    ...
    recordListPrimaryPanel.setBorder(new javax.swing.border.SoftBevelBorder(
        javax.swing.border.BevelBorder.LOWERED));

    editPatientRecordButton.setBackground(new java.awt.Color(77, 161, 190));
    editPatientRecordButton.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    editPatientRecordButton.setForeground(new java.awt.Color(255, 255, 255));
    editPatientRecordButton.setText("EDIT");
    editPatientRecordButton.setBorder(
        javax.swing.BorderFactory.createBevelBorder(
            javax.swing.border.BevelBorder.RAISED));
    editPatientRecordButton.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    patientRecordTable.setBorder(new javax.swing.border.SoftBevelBorder(
        javax.swing.border.BevelBorder.LOWERED));
    patientRecordTable.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 18)); // NOI18N
    ...
    patientRecordTable.setModel(new javax.swing.table.DefaultTableModel(
        ...
        new String[] {"Patient ID", "Given Name", "Last Name", "Middle Name",
                      "Age", "Civil Status", "Occupation", "Contact #",
                      "Address"}) {
    ...
    patientRecordTable.getSelectionModel().addListSelectionListener(
    ...
    backPatientRecordButton.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    backPatientRecordButton.setForeground(new java.awt.Color(255, 255, 255));
    backPatientRecordButton.setText("BACK");
    backPatientRecordButton.setBorder(
        javax.swing.BorderFactory.createBevelBorder(
            javax.swing.border.BevelBorder.RAISED));
    backPatientRecordButton.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    refreshPatientTable.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    refreshPatientTable.setForeground(new java.awt.Color(255, 255, 255));
    refreshPatientTable.setText("REFRESH");
    refreshPatientTable.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    printPatientTable.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    printPatientTable.setForeground(new java.awt.Color(255, 255, 255));
    printPatientTable.setText("PRINT");
    printPatientTable.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    patientRecordsLabel1.setFont(
        new java.awt.Font("Montserrat ExtraBold", 1, 18)); // NOI18N
    patientRecordsLabel1.setForeground(new java.awt.Color(255, 255, 255));
    patientRecordsLabel1.setHorizontalAlignment(
        javax.swing.SwingConstants.CENTER);
    patientRecordsLabel1.setText("All Patient Records");
    patientRecordsLabel1.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    patientRecordsLabel1.setOpaque(true);

    javax.swing.GroupLayout recordListPrimaryPanelLayout =
        new javax.swing.GroupLayout(recordListPrimaryPanel);
    recordListPrimaryPanel.setLayout(recordListPrimaryPanelLayout);
    recordListPrimaryPanelLayout.setHorizontalGroup(
        recordListPrimaryPanelLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                recordListPrimaryPanelLayout.createSequentialGroup()
                    .addGroup(
                        recordListPrimaryPanelLayout
                            .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(
                                recordListPrimaryPanelLayout
                                    ...
                                    .addPreferredGap(
                                        javax.swing.LayoutStyle
                                            .ComponentPlacement.UNRELATED)
                                    .addGroup(recordListPrimaryPanelLayout
                                                  .createParallelGroup(
                                                      javax.swing.GroupLayout
                                                          .Alignment.LEADING,
                                                      false)
                                                  .addComponent(
                                                      backPatientRecordButton,
                                                      javax.swing.GroupLayout
                                                          .DEFAULT_SIZE,
                                                      javax.swing.GroupLayout
                                                          .DEFAULT_SIZE,
    ...
    recordListPrimaryPanelLayout.setVerticalGroup(
        recordListPrimaryPanelLayout
            ...
            .addGroup(
                recordListPrimaryPanelLayout.createSequentialGroup()
                    .addGap(47, 47, 47)
                    .addComponent(backPatientRecordButton,
    ...
    javax.swing.GroupLayout recordListPanelLayout =
        new javax.swing.GroupLayout(recordListPanel);
    recordListPanel.setLayout(recordListPanelLayout);
    recordListPanelLayout.setHorizontalGroup(
        recordListPanelLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(mainHeader2, javax.swing.GroupLayout.DEFAULT_SIZE,
                          javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(recordListPanelLayout.createSequentialGroup()
                          .addGap(63, 63, 63)
                          .addComponent(recordListPrimaryPanel,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    primaryCreatePanel.setBorder(new javax.swing.border.SoftBevelBorder(
        javax.swing.border.BevelBorder.LOWERED));
    ...
    ageCreateLabel.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    ageCreateLabel.setOpaque(true);

    ageCreateText.setBackground(new java.awt.Color(175, 237, 226));
    ageCreateText.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    ...
    javax.swing.GroupLayout primaryCreatePanelLayout =
        new javax.swing.GroupLayout(primaryCreatePanel);
    primaryCreatePanel.setLayout(primaryCreatePanelLayout);
    primaryCreatePanelLayout.setHorizontalGroup(
        primaryCreatePanelLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                primaryCreatePanelLayout.createSequentialGroup()
                    .addGap(60, 60, 60)
                            ...
                            .addGroup(
                                primaryCreatePanelLayout
                                    .createParallelGroup(javax.swing.GroupLayout
                                                             .Alignment.LEADING,
                                                         false)
                                    .addGroup(primaryCreatePanelLayout
                                                  .createSequentialGroup()
                                                  .addComponent(
                                                      addressCreateLabel,
                                                      javax.swing.GroupLayout
                                    ...
                                    .addGroup(primaryCreatePanelLayout
                                                  ...
                                                  .addPreferredGap(
                                                      javax.swing.LayoutStyle
                                                          ...
                                                          .UNRELATED)
                                                  .addComponent(
                                                      civilStatusCreateText))
                                    .addComponent(
                                        patientInfoCreateLabel,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        Short.MAX_VALUE))
                            .addGroup(
    ...
    javax.swing.GroupLayout createPanelLayout =
        new javax.swing.GroupLayout(createPanel);
    createPanel.setLayout(createPanelLayout);
    createPanelLayout.setHorizontalGroup(
        createPanelLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(mainHeader1, javax.swing.GroupLayout.DEFAULT_SIZE,
                          javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(createPanelLayout.createSequentialGroup()
                          .addGap(63, 63, 63)
                          .addComponent(primaryCreatePanel,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                          .addContainerGap(71, Short.MAX_VALUE)));
    ...
    primaryUpdatePanel.setBorder(new javax.swing.border.SoftBevelBorder(
        javax.swing.border.BevelBorder.LOWERED));
    ...
    ageUpdateLabel.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    ageUpdateLabel.setOpaque(true);

    ageUpdateText.setBackground(new java.awt.Color(175, 237, 226));
    ageUpdateText.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    ...
    DateUpdateLabel.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    DateUpdateLabel.setOpaque(true);

    dateUpdateText.setBackground(new java.awt.Color(175, 237, 226));
    dateUpdateText.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    ...
    patientIDUpdateLabel.setFont(
        new java.awt.Font("Montserrat ExtraBold", 1, 14)); // NOI18N
    patientIDUpdateLabel.setForeground(new java.awt.Color(255, 255, 255));
    patientIDUpdateLabel.setHorizontalAlignment(
        javax.swing.SwingConstants.CENTER);
    patientIDUpdateLabel.setText("Patient ID:");
    patientIDUpdateLabel.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    ...
    patientIDUpdateText.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    patientIDUpdateText.setForeground(new java.awt.Color(64, 102, 143));

    javax.swing.GroupLayout primaryUpdatePanelLayout =
        new javax.swing.GroupLayout(primaryUpdatePanel);
    primaryUpdatePanel.setLayout(primaryUpdatePanelLayout);
    primaryUpdatePanelLayout.setHorizontalGroup(
        primaryUpdatePanelLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                primaryUpdatePanelLayout.createSequentialGroup()
                    .addGap(129, 129, 129)
                    .addGroup(
                        primaryUpdatePanelLayout
                            .createParallelGroup(
                            ...
                            .addGroup(
                                primaryUpdatePanelLayout.createSequentialGroup()
                                    ...
                                    .addComponent(
                                        ...
                                        278,
                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(patientInfoUpdateLabel,
                                          javax.swing.GroupLayout.DEFAULT_SIZE,
                                          javax.swing.GroupLayout.DEFAULT_SIZE,
                                          Short.MAX_VALUE))
                    .addGap(151, 151, 151)
            ...
            .addGroup(
                primaryUpdatePanelLayout.createSequentialGroup()
                    .addGap(60, 60, 60)
                    .addComponent(mainUpdateLabel,
                                  javax.swing.GroupLayout.PREFERRED_SIZE, 300,
                                  javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(backUpdateButton,
                                  javax.swing.GroupLayout.PREFERRED_SIZE, 100,
                                  javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(60, 60, 60)));
                    ...
                    .addGroup(
                        primaryUpdatePanelLayout
                            ...
                            .addGroup(
                                primaryUpdatePanelLayout.createSequentialGroup()
                                    .addComponent(
                                        patientInfoUpdateLabel,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        35,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(28, 28, 28)
                                    .addGroup(primaryUpdatePanelLayout
                                                  .createParallelGroup(
                                                      javax.swing.GroupLayout
                                                          .Alignment.BASELINE)
                                                  .addComponent(
                    ...
                    .addGroup(
                        primaryUpdatePanelLayout
                            .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.LEADING,
                                false)
                            .addComponent(ageUpdateLabel,
                                          javax.swing.GroupLayout.DEFAULT_SIZE,
                                          javax.swing.GroupLayout.DEFAULT_SIZE,
                                          Short.MAX_VALUE)
                            .addComponent(ageUpdateText,
                                          javax.swing.GroupLayout.DEFAULT_SIZE,
                                          38, Short.MAX_VALUE))
                    .addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                    .addGroup(
                        primaryUpdatePanelLayout
                            ...
                            .addComponent(
                                ...
                                javax.swing.GroupLayout.PREFERRED_SIZE, 35,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(civilStatusUpdateLabel,
                                          javax.swing.GroupLayout.DEFAULT_SIZE,
                                          41, Short.MAX_VALUE))
                    .addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    javax.swing.GroupLayout updatePanelLayout =
        new javax.swing.GroupLayout(updatePanel);
    updatePanel.setLayout(updatePanelLayout);
    updatePanelLayout.setHorizontalGroup(
        updatePanelLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(mainHeader3, javax.swing.GroupLayout.DEFAULT_SIZE,
                          1920, Short.MAX_VALUE)
            .addGroup(updatePanelLayout.createSequentialGroup()
                          .addGap(63, 63, 63)
                          .addComponent(primaryUpdatePanel,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                          .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE,
    ...
    primaryDetailsPanel.setBorder(new javax.swing.border.SoftBevelBorder(
        javax.swing.border.BevelBorder.LOWERED));
    ...
    mainDetailsLabel.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    ...
    lastNameDetailsLabel.setFont(
        new java.awt.Font("Montserrat ExtraBold", 1, 14)); // NOI18N
    lastNameDetailsLabel.setForeground(new java.awt.Color(255, 255, 255));
    lastNameDetailsLabel.setHorizontalAlignment(
        javax.swing.SwingConstants.CENTER);
    lastNameDetailsLabel.setText("Last Name:");
    lastNameDetailsLabel.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    ...
    middleNameDetailsText.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    middleNameDetailsText.setForeground(new java.awt.Color(64, 102, 143));
    middleNameDetailsText.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    ageDetailsLabel.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    ...
    civilStatusDetailsText.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    ...
    contactNumDetailsLabel.setFont(
        new java.awt.Font("Montserrat ExtraBold", 1, 14)); // NOI18N
    contactNumDetailsLabel.setForeground(new java.awt.Color(255, 255, 255));
    contactNumDetailsLabel.setHorizontalAlignment(
        javax.swing.SwingConstants.CENTER);
    contactNumDetailsLabel.setText("Contact #:");
    contactNumDetailsLabel.setBorder(
        javax.swing.BorderFactory.createEtchedBorder(
            javax.swing.border.EtchedBorder.RAISED));
    ...
    addressDetailsLabel.setFont(
        new java.awt.Font("Montserrat ExtraBold", 1, 14)); // NOI18N
    addressDetailsLabel.setForeground(new java.awt.Color(255, 255, 255));
    addressDetailsLabel.setHorizontalAlignment(
        javax.swing.SwingConstants.CENTER);
    addressDetailsLabel.setText("Address:");
    addressDetailsLabel.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    ...
    updateDetailsButton.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    updateDetailsButton.setForeground(new java.awt.Color(255, 255, 255));
    updateDetailsButton.setText("UPDATE");
    updateDetailsButton.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    backDetailsButton.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    backDetailsButton.setForeground(new java.awt.Color(255, 255, 255));
    backDetailsButton.setText("BACK");
    backDetailsButton.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    addVisitDetailsButton.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    addVisitDetailsButton.setForeground(new java.awt.Color(255, 255, 255));
    addVisitDetailsButton.setText("ADD VISIT");
    addVisitDetailsButton.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    addVisitDetailsButton.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    patientHistoryTable.setBorder(new javax.swing.border.SoftBevelBorder(
        javax.swing.border.BevelBorder.LOWERED));
    patientHistoryTable.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 12)); // NOI18N
    ...
    patientHistoryTable.setModel(new javax.swing.table.DefaultTableModel(
        ...
        new String[] {"visit_id", "Visit Reason", "Price", "Date"}) {
    ...
    patientHistoryTable.setSelectionMode(
        javax.swing.ListSelectionModel.SINGLE_SELECTION);
    ...
    patientHistoryTable.getSelectionModel().addListSelectionListener(
        new ListSelectionListener() {
          public void valueChanged(ListSelectionEvent event) {
    ...
    refreshVisitHistory.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    refreshVisitHistory.setForeground(new java.awt.Color(255, 255, 255));
    refreshVisitHistory.setText("REFRESH");
    refreshVisitHistory.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    printTable.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    deleteVisit.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    totalDentalCost.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    totalDentalCost.setOpaque(true);

    summaryVisits.setBackground(new java.awt.Color(77, 161, 190));
    summaryVisits.setFont(
        new java.awt.Font("Montserrat ExtraBold", 1, 18)); // NOI18N
    ...
    summaryVisits.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    ...
    totalVisits.setBorder(javax.swing.BorderFactory.createEtchedBorder(
        javax.swing.border.EtchedBorder.RAISED));
    totalVisits.setOpaque(true);

    javax.swing.GroupLayout primaryDetailsPanelLayout =
        new javax.swing.GroupLayout(primaryDetailsPanel);
    primaryDetailsPanel.setLayout(primaryDetailsPanelLayout);
    primaryDetailsPanelLayout.setHorizontalGroup(
        primaryDetailsPanelLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                primaryDetailsPanelLayout.createSequentialGroup()
                    .addGroup(
                        primaryDetailsPanelLayout
                            .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(
                        primaryDetailsPanelLayout
                            ...
                            .addGroup(
                                primaryDetailsPanelLayout
                                    .createSequentialGroup()
                                    .addGroup(primaryDetailsPanelLayout
                                                  .createParallelGroup(
                                                      javax.swing.GroupLayout
                                                          .Alignment.TRAILING,
                                                      false)
                    ...
                    .addGroup(
                        primaryDetailsPanelLayout
                            ...
                            .addGroup(primaryDetailsPanelLayout
                                          .createSequentialGroup()
                                          .addGap(39, 39, 39)
                                          .addComponent(backDetailsButton,
                                                        javax.swing.GroupLayout
                                                            .PREFERRED_SIZE,
                                                        38,
                                                        javax.swing.GroupLayout
    ...
    javax.swing.GroupLayout detailedPanelLayout =
        new javax.swing.GroupLayout(detailedPanel);
    detailedPanel.setLayout(detailedPanelLayout);
    detailedPanelLayout.setHorizontalGroup(
        detailedPanelLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(mainHeader4, javax.swing.GroupLayout.DEFAULT_SIZE,
                          1920, Short.MAX_VALUE)
            .addGroup(detailedPanelLayout.createSequentialGroup()
                          .addGap(63, 63, 63)
                          .addComponent(primaryDetailsPanel,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                          .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE,
    ...
    primaryDetailsPanel1.setBorder(new javax.swing.border.SoftBevelBorder(
        javax.swing.border.BevelBorder.LOWERED));
    ...
    updateUsersButton.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    updateUsersButton.setForeground(new java.awt.Color(255, 255, 255));
    updateUsersButton.setText("UPDATE");
    updateUsersButton.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    backUsersButton.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    backUsersButton.setForeground(new java.awt.Color(255, 255, 255));
    backUsersButton.setText("BACK");
    backUsersButton.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    addUsersButton.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    addUsersButton.setForeground(new java.awt.Color(255, 255, 255));
    addUsersButton.setText("ADD USER");
    addUsersButton.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    usersInfoTable.setBorder(new javax.swing.border.SoftBevelBorder(
        javax.swing.border.BevelBorder.LOWERED));
    usersInfoTable.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 12)); // NOI18N
    ...
    usersInfoTable.setModel(new javax.swing.table.DefaultTableModel(
        ...
        new String[] {"usersID", "Access Level", "Username", "Password"}) {
      boolean[] canEdit = new boolean[] {false, false, false, false};
    ...
    usersInfoTable.setSelectionMode(
        javax.swing.ListSelectionModel.SINGLE_SELECTION);
    ...
    refreshUsers.setFont(
        new java.awt.Font("Montserrat ExtraBold", 0, 14)); // NOI18N
    refreshUsers.setForeground(new java.awt.Color(255, 255, 255));
    refreshUsers.setText("REFRESH");
    refreshUsers.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    deleteUsers.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
    ...
    javax.swing.GroupLayout primaryDetailsPanel1Layout =
        new javax.swing.GroupLayout(primaryDetailsPanel1);
    primaryDetailsPanel1.setLayout(primaryDetailsPanel1Layout);
    primaryDetailsPanel1Layout.setHorizontalGroup(
        primaryDetailsPanel1Layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                primaryDetailsPanel1Layout.createSequentialGroup()
                    .addGroup(
                        primaryDetailsPanel1Layout
                            .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.LEADING)
    ...
    javax.swing.GroupLayout usersPanelLayout =
        new javax.swing.GroupLayout(usersPanel);
    usersPanel.setLayout(usersPanelLayout);
    usersPanelLayout.setHorizontalGroup(
        usersPanelLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(mainHeader5, javax.swing.GroupLayout.DEFAULT_SIZE,
                          1920, Short.MAX_VALUE)
            .addGroup(usersPanelLayout.createSequentialGroup()
                          .addGap(82, 82, 82)
                          .addComponent(primaryDetailsPanel1,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                          .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE,
    ...
    mainMenuBar.setBorder(javax.swing.BorderFactory.createBevelBorder(
        javax.swing.border.BevelBorder.RAISED));
  ...
  private void displayDashBoardButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_displayDashBoardButtonActionPerformed
    updatePatientRecordTable();
    displayRecordList();

  } // GEN-LAST:event_displayDashBoardButtonActionPerformed

  private void usersDashBoardButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_usersDashBoardButtonActionPerformed
    refreshUsersTable();
    displayUsers();
  } // GEN-LAST:event_usersDashBoardButtonActionPerformed

  private void createCreateButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_createCreateButtonActionPerformed
    if (givenNameCreateText.getText().equals("") |
        ageCreateText.getText().equals("") |
        civilStatusCreateText.getText().equals("") |
        occupationCreateText.getText().equals("") |
        contactNumCreateText.getText().equals("") |
        addressCreateText.getText().equals("")) {
      ...
      DefaultTableModel ptnRecordsTable =
          (DefaultTableModel)patientRecordTable.getModel();
      DefaultTableModel ptnHistoryTable =
          (DefaultTableModel)patientHistoryTable.getModel();
      int nextId = ptnRecordsTable.getRowCount() + 1;
      String data[] = {String.valueOf(nextId),
                       givenNameCreateText.getText(),
                       middleNameCreateText.getText(),
                       lastNameCreateText.getText(),
                       String.valueOf(age),
                       civilStatusCreateText.getText(),
                       occupationCreateText.getText(),
                       contactNumCreateText.getText(),
                       addressCreateText.getText()};
      ...
      try {
        Database db = new Database();
        String query =
            "INSERT INTO patientrecords (id, given_name, middle_name, last_name, age, civil_status, occupation, contact_no, address) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (Connection conn = db.connect();
             PreparedStatement pstmt = conn.prepareStatement(query)) {
        ...
        String queryVisit =
            "INSERT INTO patientvisit (patient_id, reason, price, date) VALUES (?, ?, ?, ?);";
        try (Connection conn = db.connect();
             PreparedStatement pstmt = conn.prepareStatement(queryVisit)) {
          pstmt.setInt(1, nextId);
        ...
        String dataVisit[] = {
            String.valueOf(nextId), reasonCreateText.getText(),
            priceCreateText.getText(), dateCreateText.getText()};
  ...
  private void editPatientRecordButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_editPatientRecordButtonActionPerformed
    ...
    if (selectedRowIndex != -1) {
      ...
      String givenName =
          patientRecordTable.getValueAt(selectedRowIndex, 1).toString();
      String middleName =
          patientRecordTable.getValueAt(selectedRowIndex, 2).toString();
      String lastName =
          patientRecordTable.getValueAt(selectedRowIndex, 3).toString();
      String age =
          patientRecordTable.getValueAt(selectedRowIndex, 4).toString();
      String civilStatus =
          patientRecordTable.getValueAt(selectedRowIndex, 5).toString();
      String occupation =
          patientRecordTable.getValueAt(selectedRowIndex, 6).toString();
      String contactNo =
          patientRecordTable.getValueAt(selectedRowIndex, 7).toString();
      String address =
          patientRecordTable.getValueAt(selectedRowIndex, 8).toString();
  ...
  private void deletePatientRecordButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_deletePatientRecordButtonActionPerformed
    int selectedRowIndex = patientRecordTable.getSelectedRow();
    ...
    if (selectedRowIndex != -1) {
      ...
      int confirm = JOptionPane.showConfirmDialog(
          this,
          "Are you sure you want to delete this record? All associated visit records will also be deleted.",
          "Confirm Deletion", JOptionPane.YES_NO_OPTION);
      if (confirm == JOptionPane.YES_OPTION) {
        // Get the ID of the selected row
        int id = Integer.parseInt(
            patientRecordTable.getValueAt(selectedRowIndex, 0).toString());
        ...
        for (int i = historyModel.getRowCount() - 1; i >= 0; i--) {
          if (Integer.parseInt(historyModel.getValueAt(i, 0).toString()) ==
              id) {
  ...
  private void addPatientRecordButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_addPatientRecordButtonActionPerformed
    displayCreate();
  } // GEN-LAST:event_addPatientRecordButtonActionPerformed

  private void readPatientRecordButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_readPatientRecordButtonActionPerformed
    ...
    if (selectedRowIndex != -1) {
      ...
      String totalVisitHistory =
          "Total Visits: " + patientHistoryTable.getModel().getRowCount();
  ...
  private void backPatientRecordButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_backPatientRecordButtonActionPerformed
    displayMenu();
  } // GEN-LAST:event_backPatientRecordButtonActionPerformed

  private void backCreateButtonActionPerformed(
      java.awt.event
          .ActionEvent evt) { // GEN-FIRST:event_backCreateButtonActionPerformed
    updatePatientRecordTable();
    displayRecordList();
  } // GEN-LAST:event_backCreateButtonActionPerformed

  private void clearCreateButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_clearCreateButtonActionPerformed
    givenNameCreateText.setText("");
    middleNameCreateText.setText("");
    lastNameCreateText.setText("");
    ageCreateText.setText("");
  ...
  private void updateUpdateButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_updateUpdateButtonActionPerformed
    int selectedRowIndex = patientRecordTable.getSelectedRow();
    ...
    if (selectedRowIndex != -1) {
      ...
      if (!id.equals(
        ...
        // Show a confirmation dialog
        int confirm = JOptionPane.showConfirmDialog(
            this, "Are you sure you want to update this record?",
        ...
        if (confirm == JOptionPane.YES_OPTION) {
          ...
          try {
            Database db = new Database();
            String query =
                "UPDATE patientrecords SET given_name = ?, middle_name = ?, last_name = ?, age = ?, civil_status = ?, occupation = ?, contact_no = ?, address = ? WHERE id = ?";
            try (Connection conn = db.connect();
                 PreparedStatement pstmt = conn.prepareStatement(query)) {
              pstmt.setString(1, givenName);
  ...
  private void backUpdateButtonActionPerformed(
      java.awt.event
          .ActionEvent evt) { // GEN-FIRST:event_backUpdateButtonActionPerformed
    updatePatientRecordTable();
    displayRecordList();
  } // GEN-LAST:event_backUpdateButtonActionPerformed

  private void addVisitUpdateButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_addVisitUpdateButtonActionPerformed
    // Get the currently selected ID from the text box
    int currentId = Integer.parseInt(
        patientIDUpdateText.getText()); // Assuming patientIDUpdateText is the
                                        // JTextField for the current ID

    // Confirmation dialog
    int confirm = JOptionPane.showConfirmDialog(
        this, "Are you sure you want to add this visit?", "Confirm Add Visit",
    ...
    if (confirm == JOptionPane.YES_OPTION) {
      ...
      try {
        ...
        try (Connection conn = db.connect();
          ...
          pstmt.setInt(1, currentId);
          pstmt.setString(
              2, reasonUpdateText.getText()); // Assuming reasonCreateText is
                                              // the JTextField for the reason
          pstmt.setString(
              3, priceUpdateText.getText()); // Assuming priceCreateText is the
                                             // JTextField for the price
          pstmt.setString(
              4, dateUpdateText.getText()); // Assuming dateCreateText is the
                                            // JTextField for the date
          pstmt.executeUpdate();
        }

        // Add the new visit to the patientHistoryTable
        String dataVisit[] = {
            String.valueOf(currentId), reasonUpdateText.getText(),
            priceUpdateText.getText(), dateUpdateText.getText()};
        DefaultTableModel model =
            (DefaultTableModel)patientHistoryTable.getModel();
        model.addRow(dataVisit);
  ...
  private void updateDetailsButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_updateDetailsButtonActionPerformed
    int selectedRowIndex = patientRecordTable.getSelectedRow();
  ...
  private void backDetailsButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_backDetailsButtonActionPerformed
    updatePatientRecordTable();
    displayRecordList();
  } // GEN-LAST:event_backDetailsButtonActionPerformed

  private void addVisitDetailsButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_addVisitDetailsButtonActionPerformed
    int selectedRowIndex = patientRecordTable.getSelectedRow();
  ...
  private void lastNameCreateTextActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_lastNameCreateTextActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_lastNameCreateTextActionPerformed

  private void middleNameCreateTextActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_middleNameCreateTextActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_middleNameCreateTextActionPerformed

  private void refreshPatientTableActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_refreshPatientTableActionPerformed
    updatePatientRecordTable();
  } // GEN-LAST:event_refreshPatientTableActionPerformed

  private void patientIDDetailsTextActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_patientIDDetailsTextActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_patientIDDetailsTextActionPerformed

  private void addressUpdateTextActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_addressUpdateTextActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_addressUpdateTextActionPerformed

  private void patientRecordTableMousePressed(
      java.awt.event
          .MouseEvent evt) { // GEN-FIRST:event_patientRecordTableMousePressed
    // TODO add your handling code here:
  } // GEN-LAST:event_patientRecordTableMousePressed

  private void middleNameDetailsTextActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_middleNameDetailsTextActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_middleNameDetailsTextActionPerformed

  private void searchPatientTextActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_searchPatientTextActionPerformed
  ...
  private void refreshVisitHistoryActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_refreshVisitHistoryActionPerformed
    refreshVisitHistory();
  } // GEN-LAST:event_refreshVisitHistoryActionPerformed

  private void printTableActionPerformed(
      java.awt.event
          .ActionEvent evt) { // GEN-FIRST:event_printTableActionPerformed
    String firstName =
        givenNameDetailsText
            .getText(); // replace with your method to get the first name
    String lastName =
        lastNameDetailsText
            .getText(); // replace with your method to get the last name
    MessageFormat header =
        new MessageFormat(firstName + " " + lastName + " - Dental Records");
    MessageFormat footer = new MessageFormat("Page {0,number,integer}");
    try {
      PrintRequestAttributeSet set = new HashPrintRequestAttributeSet();
      set.add(OrientationRequested.PORTRAIT);
      patientHistoryTable.print(JTable.PrintMode.FIT_WIDTH, header, footer,
                                true, set,
                                true); // changed to patientHistoryTable
  ...
  private void printPatientTableActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_printPatientTableActionPerformed
    MessageFormat header = new MessageFormat("Patient Records");
    MessageFormat footer = new MessageFormat("Page {0,number,integer}");
    try {
      PrintRequestAttributeSet set = new HashPrintRequestAttributeSet();
      set.add(OrientationRequested.LANDSCAPE);
      patientRecordTable.print(JTable.PrintMode.FIT_WIDTH, header, footer, true,
                               set, true);
      JOptionPane.showMessageDialog(null, "\n"
                                              + "Printed Successfully!");
    } catch (java.awt.print.PrinterException e) {
  ...
  private void deleteVisitActionPerformed(
      java.awt.event
          .ActionEvent evt) { // GEN-FIRST:event_deleteVisitActionPerformed
    int selectedRow = patientHistoryTable.getSelectedRow();
    if (selectedRow != -1) {
      // Show confirmation dialog
      int dialogResult = JOptionPane.showConfirmDialog(
          null, "Would you like to delete the selected visit?", "Warning",
          JOptionPane.YES_NO_OPTION);
  ...
  private void updateUsersButtonActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_updateUsersButtonActionPerformed
    ...
    if (selectedRowIndex != -1) {
      ...
      String usersID =
          usersInfoTable.getValueAt(selectedRowIndex, 0).toString();

      // Check if there are changes
      if (!accesslevel.equals(
              usersInfoTable.getValueAt(selectedRowIndex, 1).toString()) ||
          !username.equals(
              usersInfoTable.getValueAt(selectedRowIndex, 2).toString()) ||
          !password.equals(
              usersInfoTable.getValueAt(selectedRowIndex, 3).toString())) {

        // Show a confirmation dialog
        int confirm = JOptionPane.showConfirmDialog(
            this, "Are you sure you want to update this user?",
            "Confirm Update", JOptionPane.YES_NO_OPTION);
        if (confirm == JOptionPane.YES_OPTION) {
          // Update the row in the JTable
  ...
  private void backUsersButtonActionPerformed(
      java.awt.event
          .ActionEvent evt) { // GEN-FIRST:event_backUsersButtonActionPerformed
    displayMenu();
  } // GEN-LAST:event_backUsersButtonActionPerformed

  private void addUsersButtonActionPerformed(
      java.awt.event
          .ActionEvent evt) { // GEN-FIRST:event_addUsersButtonActionPerformed
    // Get the currently selected ID from the text box
    // int currentId = Integer.parseInt(patientIDUpdateText.getText());  //
    // Assuming patientIDUpdateText is the JTextField for the current ID

    // Confirmation dialog
    int confirm = JOptionPane.showConfirmDialog(
        this, "Are you sure you want to add this User?", "Confirm Add Visit",
        JOptionPane.YES_NO_OPTION);
    if (confirm == JOptionPane.YES_OPTION) {
      // Insert the new visit into the patientvisit table in the database
      try {
        Database db = new Database();
        String queryVisit =
            "INSERT INTO usersdata (accessLevel, username, password) VALUES (?, ?, ?)";
        try (Connection conn = db.connect();
             PreparedStatement pstmt = conn.prepareStatement(queryVisit)) {
  ...
  private void accessLevelUsersTextActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_accessLevelUsersTextActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_accessLevelUsersTextActionPerformed

  private void refreshUsersActionPerformed(
      java.awt.event
          .ActionEvent evt) { // GEN-FIRST:event_refreshUsersActionPerformed
    refreshUsersTable();
  } // GEN-LAST:event_refreshUsersActionPerformed

  private void deleteUsersActionPerformed(
      java.awt.event
          .ActionEvent evt) { // GEN-FIRST:event_deleteUsersActionPerformed
    int selectedRow = usersInfoTable.getSelectedRow();
    if (selectedRow != -1) {
      // Show confirmation dialog
      int dialogResult = JOptionPane.showConfirmDialog(
          null, "Would you like to delete the selected user?", "Warning",
          JOptionPane.YES_NO_OPTION);
      if (dialogResult == JOptionPane.YES_OPTION) {
        // User confirmed deletion, get the ID of the selected row
  ...
  private void usersInfoTableMouseClicked(
      java.awt.event
          .MouseEvent evt) { // GEN-FIRST:event_usersInfoTableMouseClicked
    int selectedRowIndex = usersInfoTable.getSelectedRow();
  ...
  private void
  menuMenuBarMouseClicked(java.awt.event.MouseEvent
                              evt) { // GEN-FIRST:event_menuMenuBarMouseClicked
    displayMenu();
  } // GEN-LAST:event_menuMenuBarMouseClicked

  private void searchActionMenuBarMouseClicked(
      java.awt.event
          .MouseEvent evt) { // GEN-FIRST:event_searchActionMenuBarMouseClicked

  } // GEN-LAST:event_searchActionMenuBarMouseClicked

  private void createActionMenuBarMouseClicked(
      java.awt.event
          .MouseEvent evt) { // GEN-FIRST:event_createActionMenuBarMouseClicked

  } // GEN-LAST:event_createActionMenuBarMouseClicked

  private void usersMenuBarMouseClicked(
      java.awt.event
          .MouseEvent evt) { // GEN-FIRST:event_usersMenuBarMouseClicked
    displayUsers();
  } // GEN-LAST:event_usersMenuBarMouseClicked

  private void searchActionMenuBarActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_searchActionMenuBarActionPerformed
    displayRecordList();
  } // GEN-LAST:event_searchActionMenuBarActionPerformed

  private void createActionMenuBarActionPerformed(
      java.awt.event.ActionEvent
          evt) { // GEN-FIRST:event_createActionMenuBarActionPerformed
    displayCreate();
  } // GEN-LAST:event_createActionMenuBarActionPerformed

  private void logOutButtonActionPerformed(
      java.awt.event
          .ActionEvent evt) { // GEN-FIRST:event_logOutButtonActionPerformed
